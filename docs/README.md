...
- `index.html` er en ren landingsside, der linker til de enkelte dashboard-demoer (fx `streamlit.html`).
...
- For lokal test: `python -m http.server --directory docs` og åbn `http://localhost:8000/` i en browser. Landingsside: `/`, Streamlit-demo: `/streamlit.html`.
